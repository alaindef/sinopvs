...
void CRenderer::Reshape(GLsizei width, GLsizei height) {  // GLsizei for non-negative integer
...
void CRenderer::DrawImage(CTexture *tex, Rect *sourcerect, Color color)
{
    ...
    if (sourcerect == nullptr) {
        glTexCoord2f(0, 0); glVertex2f(0,tex->h);
        glTexCoord2f(0, 1); glVertex2f(0,0);
        glTexCoord2f(1, 1); glVertex2f(tex->w,0);
        glTexCoord2f(1, 0); glVertex2f(tex->w ,tex->h);
    }
    else
    {
        ...
        glTexCoord2f(leftpct, toppct);      glVertex2f(0,0);
        glTexCoord2f(leftpct, bottompct);   glVertex2f(0,h);
        glTexCoord2f(rightpct, bottompct);  glVertex2f(w,h);
        glTexCoord2f(rightpct, toppct);     glVertex2f(w,0);
    }
    glEnd();
